@include('layouts.header')
    ...
    <div class="wrapper vh-100">
      <div class="row align-items-center h-100">
                ...
                {{-- form --}}
        <form action="{{ route('admin.register') }}" method="POST" class="col-lg-6 col-md-8 col-10 mx-auto">
          @csrf
          <div class="mx-auto text-center my-4">
            ...
            <h2 class="my-3">{{__('Register Admin')}}</h2>
          </div>
    ...
    <li>{{ __('Can’t be the same as a previous password') }}</li>
          ...
          <center><a href="{{ route('admin.login') }}" >{{__('Already Registered?')}}</a></center>
