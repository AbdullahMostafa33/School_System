      ...
      <main role="main" class="main-content">
        <div class="row">
                ...
                <div class="col-md-12 my-4">
                  <h2 class="h4 mb-1">{{__('Add Distribute Teachers')}}</h2>
                    ...
                    <div class="card-body">
                      ...
                      {{-- second form --}}
                       <div class="toolbar row mb-3">
                        <div class="col">
                          <form action="{{route('distribute.specialties.create')}}" class="form-inline">
                            <div class="form-row">
                      ...
                      <!-- table -->
                      <form action="{{route('distribute.specialties.store')}}" method="POST">
                        @csrf                        
                                ...
                                <select class="custom-select my-1 mr-sm-2 select_stage" name="teachers_id[]" >                                                                                                                              ">
                                  ...
                                  @foreach ($specialty->teachers as $teacher)
                                      <option value="{{$teacher->id}}"
                                        {{old('teachers_id.'.$i)==$teacher->id ? 'selected':''}}
                                        >{{$teacher->name}}</option>
                                  @endforeach                               
                                </select>
                              </div>
                      ...
                      <center><button class="btn btn-primary float-ml-3">{{__('Distribute')}}</button></center>
                      </form>
