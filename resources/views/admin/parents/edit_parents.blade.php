                                        ...
                                        <div class="form-row">
                                         ...
                                         <div class="form-row">
                                             <div class="form-group col-md-6">
                                                 ...
                                                 <select name="nationality_parent" class="form-control required" required>
                                                     <option  disabled selected>Select Nationality</option>
                                                     @foreach($nationalities as $nationality)
                                                         <option value="{{ $nationality->name }}" {{$nationality->name==$parent->nationality?'selected':''}}>{{ $nationality->name }}</option>
                                                     @endforeach
                                                 </select>
                                             </div>
                                             <div class="form-group col-md-6">
